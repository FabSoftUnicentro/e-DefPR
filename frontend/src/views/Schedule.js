    ...
    return <div className='schedule'>
      ...
      <div className='schedule-table'>
        <CommandBar
          ...
          items={[
            { key: 'k1', name: 'Atualizar', iconProps: { iconName: 'Refresh' } },
            { key: 'k2', name: 'Gerar Relatório', iconProps: { iconName: 'TextDocument' } },
            { key: 'l1', name: 'Filtrar', iconProps: { iconName: 'Filter' } }
          ]}
        />
        <DetailsList
